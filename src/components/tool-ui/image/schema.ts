...
export const SourceSchema = z.object({
  label: z.string(),
  iconUrl: z.string().url().optional(), // Fixed: z.string().url() instead of z.url()
  url: z.string().url().optional(), // Fixed: z.string().url() instead of z.url()
});
...
export const SerializableImageSchema = z.object({
  ...
  assetId: z.string(),
  src: z.string().url(), // Fixed: z.string().url() instead of z.url()
  alt: z.string().min(1, "Images require alt text for accessibility"),
  title: z.string().optional(),
  description: z.string().optional(),
  href: z.string().url().optional(), // Fixed: z.string().url() instead of z.url()
